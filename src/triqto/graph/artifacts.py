...
def load_pair_artifact(
    ...
    pair = GraphSamplePair(
        ...
        identifiability_reason=metadata["identifiability_reason"],
        diagnosis_supervision_mask=metadata["diagnosis_supervision_mask"],
        action_supervision_mask=metadata["action_supervision_mask"],
        born_target_mask=metadata["born_target_mask"],
