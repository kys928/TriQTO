#!/usr/bin/env python3
"""Launch the frozen Step-14 fit+selection cohort generator on RunPod.

This launcher has one scientific operation only: materialize the frozen Step-14
`development` partition (600 fit + 150 selection families). It cannot request
simulator outer materialization, future-hardware reserve access, training, or
QPU execution.
"""
...
def main() -> None:
    ...
    progress_every = int(request.get("progress_every", 25))
    if progress_every < 1 or progress_every > 10000:
        raise ValueError("progress_every must be between 1 and 10000")
    ...
    try:
        ...
        record = {
            ...
            "runner": "step14_cross_motif",
            "scientific_operation": "generate_development",
